...
public class Assignememnt1_DataTypes {

	public static void main(String[] args) {
		// 1. Temperature of a city in degrees Celsius: 25.5
		float tempOfCity = 25.5f;
		System.out.println("Temperature of a city in degrees Celsius is : " + tempOfCity);

		// 2. Whether a customer has placed an order: true or false
		// bolean is used to decide true or false i.e yes or no or 0/1
